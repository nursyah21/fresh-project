...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"/home/nursyah/Downloads/azure/fresh-project/.data/kv"}));
...
const _lazy_WZ5Tsk = () => import('../handlers/renderer.mjs');

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_WZ5Tsk, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_WZ5Tsk, lazy: true, middleware: false, method: undefined }
];
...
function getAzureParsedCookiesFromHeaders(headers) {
